...
/**
 * Test-Script für beide E-Mail-Systeme mit expliziter .env.local Ladung
 * Lädt Umgebungsvariablen aus .env.local Datei
 */
...
async function testEmailSystems() {
  console.log('🧪 Teste beide E-Mail-Systeme mit expliziter .env.local Ladung...\n');

  // Zeige alle geladenen Umgebungsvariablen
  ...
  console.log(`SMTP_PASSWORD: ${process.env.SMTP_PASSWORD ? '***GESETZT***' : 'NICHT GESETZT'}`);
  console.log(`SMTP_FROM: ${process.env.SMTP_FROM || 'NICHT GESETZT'}`);
  console.log(`SMTP_SECURE: ${process.env.SMTP_SECURE || 'NICHT GESETZT'}\n`);
  ...
  if (!smtpConfig.auth.user || !smtpConfig.auth.pass) {
    ...
    console.log('\n💡 So fügen Sie die SMTP-Konfiguration hinzu:');
    console.log('1. Öffnen Sie die Datei .env.local');
    console.log('2. Fügen Sie folgende Zeilen hinzu:');
    console.log('');
    console.log('# E-Mail Konfiguration');
    console.log('SMTP_HOST=smtp.gmail.com');
    console.log('SMTP_PORT=587');
    console.log('SMTP_SECURE=false');
    console.log('SMTP_USER=ihre-email@gmail.com');
    console.log('SMTP_PASSWORD=ihr-app-passwort');
    console.log('SMTP_FROM=noreply@gemilike.de');
    console.log('');
    console.log('3. Speichern Sie die Datei');
    console.log('4. Führen Sie das Test-Script erneut aus\n');

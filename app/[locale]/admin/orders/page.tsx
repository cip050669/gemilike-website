      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-bold mb-4 text-white">Bestellungen</h1>
        ...
        <div className="bg-gray-800/30 rounded-lg shadow-sm border p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              <label htmlFor="date-from" className="block text-sm font-medium text-gray-200 mb-2">
                Von Datum
              </label>
              <input
                type="date"
            ...
            <div>
              <label htmlFor="date-to" className="block text-sm font-medium text-gray-200 mb-2">
                Bis Datum
              </label>
              <input
                type="date"

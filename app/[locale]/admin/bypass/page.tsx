...
export default function BypassAdminPage() {
  console.log('🚀 BypassAdminPage component loaded');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Einfachste Authentifizierung - keine API-Calls, keine NextAuth
    if (email === 'admin@gemilike.com' && password === 'admin123') {
      console.log('✅ Bypass admin login successful');
          ...
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              <CardTitle className="text-2xl font-bold text-white">
                Admin-Anmeldung (Bypass)
              </CardTitle>
              <CardDescription className="text-gray-300">
                Komplett umgeht alle Authentifizierungsprobleme
              </CardDescription>
            </div>
          </CardHeader>

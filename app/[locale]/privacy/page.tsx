  ...
  return (
    <div className="space-y-8">
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">1. Verantwortlicher</h2>
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">2. Allgemeines zur Datenverarbeitung</h2>
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">3. Bereitstellung der Website</h2>
        <div className="space-y-4 text-gray-200">
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">4. Verwendung von Cookies</h2>
          <div className="space-y-4 text-gray-200">
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">5. Registrierung und Bestellung</h2>
          <div className="space-y-4 text-gray-200">
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">6. E-Mail-Kontakt</h2>
          <div className="space-y-4 text-gray-200">
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">7. Rechte der betroffenen Person</h2>
          <div className="space-y-4 text-gray-200">
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">8. Datensicherheit</h2>
          <div className="space-y-4 text-gray-200">
      ...
      <div className="story-card">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-200">9. Aktualität und Änderung</h2>
          <div className="space-y-2 text-gray-200">
                ...
                <>
                  <div className="space-y-4 text-center mb-8">
                    <h1 className="text-4xl md:text-5xl font-impact font-weight-impact">
                      <span className="gemilike-text-gradient">Datenschutzerklärung</span>
                    </h1>
                  </div>

        ...
        {sorted.length === 0 ? (
          ...
          <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
            {sorted.map((article) => (
              <article
                key={article.id}
                className="flex h-full flex-col overflow-hidden rounded-3xl border border-white/10 bg-surface/80 shadow-lg ring-1 ring-black/30 transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl"
              >

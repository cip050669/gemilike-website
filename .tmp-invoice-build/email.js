...
exports.emailTemplates = {
    ...
    newsletterCampaign: ({ subject, content, unsubscribeLink, locale = 'de' }) => {
        const greetings = locale === 'de'
    ...
    orderConfirmation: {
        subject: (locale, orderNumber) => locale === 'de'
            ? `Bestellbestätigung #${orderNumber} - Gemilike`
            : `Order Confirmation #${orderNumber} - Gemilike`,
        html: ({ orderNumber, customerName, orderDate, totalAmount, currency, items, locale = 'de' }) => {

...
export const cutGemstones: CutGemstone[] = [
  {
    ...
    price: 12800,
    currency: 'EUR',
    images: ['/products/emerald.jpg'],
    mainImage: '/products/emerald.jpg',
    origin: 'Kolumbien',
  ...
  },
  {
    ...
    price: 18500,
    currency: 'EUR',
    images: ['/products/ruby.jpg'],
    mainImage: '/products/ruby.jpg',
    origin: 'Myanmar',
    originType: 'natürlich',
    mineLocation: 'Mogok',
    dimensions: {
  ...
  },
  {
    ...
    price: 14900,
    currency: 'EUR',
    images: ['/products/diamond.jpg'],
    mainImage: '/products/diamond.jpg',
    origin: 'Südafrika',
    originType: 'natürlich',
    dimensions: {
      length: 6.5,
...
export const roughGemstones: RoughGemstone[] = [
  {
    ...
    price: 5200,
    currency: 'EUR',
    images: ['/products/rough-paraiba.jpg'],
    mainImage: '/products/rough-paraiba.jpg',
    origin: 'Brasilien',
    originType: 'natürlich',

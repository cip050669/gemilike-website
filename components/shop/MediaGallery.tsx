...
export function MediaGallery({ images, videos = [], gemName, className, certification, inStock }: MediaGalleryProps) {
  ...
  if (!mounted) {
    return (
      <div className={cn("w-full", className)}>
        <div className="bg-gray-700/30 rounded-lg border shadow-sm">
          <Image
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div 
        className="relative bg-gray-700/30 rounded-lg group border shadow-sm mb-2 overflow-hidden max-h-[300px]"
        role="img"
      ...
      >
        {isCurrentVideo ? (
          <video
            ...
            className="w-full h-full max-h-[300px] object-contain bg-gray-700/50"
        ...
        {isCurrentVideo && isVideoPlaying !== selectedIndex && (
          <div className="absolute inset-0 flex items-center justify-center bg-gray-700/50/20">
            <Button
              size="lg"
        ...
        {allMedia.length > 1 && (
          <div 
            className="absolute bottom-2 left-2 bg-gray-700/50/50 text-white text-xs px-1.5 py-0.5 rounded"
              ...
              {media.type === 'video' ? (
                <div className="relative w-full h-full bg-muted flex items-center justify-center">
                  <video
                    ...
                    muted
                  />
                  <div className="absolute inset-0 flex items-center justify-center bg-gray-700/50/40">
